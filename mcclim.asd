...
(defsystem :clim-system
  :components 
  ((:file "patch")
   (:module "System/Fix" :pathname "Lisp-Dep"
	    :components
	    ((:file   
	      #+cmu       "fix-cmu"
	      #+scl       "fix-scl"
	      ...
	      #+clisp     "fix-clisp")))
   (:file "package")
   (:module "System/MP" :pathname "Lisp-Dep"
	    :components
	    ((:file 
	      #.(first
		 (list
...
(defsystem :clim-gtkairo
    :depends-on (:clim-core :clim-input :cffi)
    :components
...
(defsystem :clim-looks
  :depends-on (:clim-core :clim-input
	       #+clim-sdl            :clim-sdl
	       #+clim-clx            :clim-clx
